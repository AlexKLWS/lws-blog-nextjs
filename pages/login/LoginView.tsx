    ...
    <DefaultLayoutWrapper hideFooter hideHeader>
      <div className={styles.LoginContainer}>
        ...
        <p className={styles.LoginGDPRInfo}>
          ...
          store a <a href='https://jwt.io/introduction/'>JWT token</a> used to authenticate the user. The token is
          stored for 24 hours only. By logging in you consent to store this token on your device. If you had logged in
          previously and would like to remove the token cookie, press the button below.
        </p>
